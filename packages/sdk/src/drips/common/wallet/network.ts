...
import {
  nextFilecoinSettlementDate,
  nextMainnetSettlementDate,
} from "&/drips/common/utils/settlement-date.js";
...
export const NETWORK_CONFIG: ValueForEachSupportedChain<Network> = {
  ...
  [314]: {
    ...
    explorer: {
      name: "Blockscout",
      linkTemplate: (txHash: string) =>
        `https://filecoin.blockscout.com/tx/${txHash}`,
    },
    contracts: {
...
const PUBLIC_NETWORK = getOptionalEnvVar("PUBLIC_NETWORK") ?? "11155111";
