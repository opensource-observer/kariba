...
import sty from "./PlasmicButton.module.css"; // plasmic-import: DN2OfxkKwMtl/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: w-WY-0yd0Dh6/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__peRu2)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__jCbfu)}
                role={"img"}
              />
            ),
